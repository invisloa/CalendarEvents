...
namespace CalendarT1.Models
{
	public abstract class AbstractEventModel : IGeneralEventModel
	{
		...
		public IEventTypeModel EventType { get; set; }
		...
		public AbstractEventModel(string title, string description, DateTime startTime, DateTime endTime, IEventTypeModel eventType, bool isCompleted = false, DateTime? postponeTime = null, bool wasShown = false)
		{
			Id = Guid.NewGuid();
			Title = title;
